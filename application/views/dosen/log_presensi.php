                ...
                <table id="datatable" class="table table-striped jambo_table bulk_action" >
                    ...
                    ?>
                        ...
                        ?>
                                    ...
                                    <form action="<?=base_url()?>dosen/updateabsen" method="post" name="postform" enctype="multipart/form-data" data-toggle="validator">                        
                                    <input type="hidden" name="id_abs_dosen" value="<?=$data->id_abs_dosen?>"/> 
