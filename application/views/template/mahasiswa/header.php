        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li >
                        <a href="<?php echo base_url() ?>mahasiswa/"><i class="fa fa-fw fa-dashboard"></i> Beranda</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() ?>mahasiswa/jadwal_mhs"><i class="fa fa-fw fa-dashboard"></i>Jadwal</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() ?>mahasiswa/log_presensi"><i class="fa fa-fw fa-dashboard"></i>Data Presensi</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
